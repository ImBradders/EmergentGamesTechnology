...
void FTcpSocketReceivedMessageDelegate_DelegateWrapper(const FScriptDelegate& TcpSocketReceivedMessageDelegate, int32 ConnectionId, TArray<uint8>& Message)
{
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TcpSocketPlugin_Source_TcpSocketPlugin_Public_TcpSocketConnection_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TcpSocketPlugin_Source_TcpSocketPlugin_Public_TcpSocketConnection_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TcpSocketPlugin_Source_TcpSocketPlugin_Public_TcpSocketConnection_h_172190349(TEXT("/Script/TcpSocketPlugin"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TcpSocketPlugin_Source_TcpSocketPlugin_Public_TcpSocketConnection_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_TcpSocketPlugin_Source_TcpSocketPlugin_Public_TcpSocketConnection_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
